...
Use of this Software is limited and subject to the ANT SoftDevice License Agreement. The Agreement accompanies the Software in the root directory of the .zip file containing this Software.
**/
...
*          ANT activities.
*
* @param[in] ucExtID = @ref SD_ANT_EXT0_ID_WAKEON_RF_ACTIVITY_CONFIG_SET
...
*
* @param[in] ucExtID = @ref SD_ANT_EXT0_ID_WAKEON_RF_ACTIVITY_CONFIG_GET
...
*
* @param[in] ucExtID = @ref SD_ANT_EXT0_ID_ENHANCED_CHANNEL_SPACING_SET
